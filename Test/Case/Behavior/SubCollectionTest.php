 ...
 *
 * @filesource
 * @copyright     Copyright (c) 2012, Brandon PLasters
 * @link          www.brandonplasters.com
 * @package       mongodb
 ...
 * @subpackage    mongodb.tests.cases.behaviors
 */
class SubCollectionPost extends AppModel {
 ...
 */
	public $actsAs = array(
		'Mongodb.SubCollection'
	);


	public $parentCollection = 'SubCollectionUser';
 ...
 * @subpackage    mongodb.tests.cases.behaviors
 */
class SubCollectionUser extends AppModel {
 ...
 */
	public function startTest() {
		...
		$this->Post = ClassRegistry::init(array('class' => 'SubCollectionPost', 'alias' => 'Post', 'ds' => 'mongo_test'));
